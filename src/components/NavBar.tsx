...
export default function NavBar() {
  ...
  return (
    <nav className="border p-4 flex justify-between relative">

      <svg className="fill-current h-10 w-10 animate-scaleIn" viewBox="0 0 61.63 61.63">
      ...
      <div className="gap-2 hidden md:flex">
        {user ? (
          <>
            ...
            <button
              className="flex justify-center py-2 border flex-1 w-full px-2"
              onClick={logout}
            >
              Logout
            </button>
      ...
      <button
        className="flex justify-center py-2 border px-2 md:hidden"
      ...
      {dropdownOpen && (
        <div className="absolute top-16 left-0 right-0 bg-white rounded-lg shadow-lg md:hidden">
